# -*- coding: utf-8 -*-
"""
Created on Thu Apr  4 09:56:16 2019
...
#start = '2015-05-10'
#end = '2015-05-15'
#data_s = hf.NWIS(site, 'dv', start, end)
#data_s.get_data()
#s=pd.DataFrame(data_s.df())
#s.columns=('discharge','b')
#s=s.drop(columns='b')
#start = '2015-06-10'
#end = '2015-06-15'
#data_o = hf.NWIS(site, 'dv', start, end)
#data_o.get_data()
#o=pd.DataFrame(data_o.df())
#o.columns=('discharge','b')
#o=o.drop(columns='b')
